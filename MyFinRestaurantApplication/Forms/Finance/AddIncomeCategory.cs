...
namespace ManagerApplication
{
    public partial class AddIncomeCategory : Form
    {
        ...
        public AddIncomeCategory(IncomeCategory sendedCategory = null)
        {
            InitializeComponent();
            ...
            if (txtName.Text != "")
            {
                try
                {
                    if (category != null)
                    {
                        ...
                        if (await new IncomeCategory().OnUpdateAsync(category))
                        {
                    ...
                    {
                        var aaa = new IncomeCategory()
                        {
                            category_name = txtName.Text,
                        };
                        if (await new IncomeCategory().OnInsertAsync(aaa))
                        {
