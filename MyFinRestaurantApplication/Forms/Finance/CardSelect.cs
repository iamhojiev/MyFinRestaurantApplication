...
{
    public partial class CardSelect : Form
    {
        ...
        public void CreateTableLayoutGroup(List<Card> cards, Control parent, int count)
        {
            ...
            for (int j = 0; j < cards.Count; j++)
            {
                ...
                myTable.button.Text = string.Format("{0}\nБаланс: {1} {2}", i.card_name, i.card_balance, currency);
        ...
        {
            if (((Guna2Button)sender).Tag is Card aaa)
            {
                selectedCard = aaa;
